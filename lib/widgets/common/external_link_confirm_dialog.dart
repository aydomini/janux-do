    ...
    switch (level) {
      ...
      case LinkRiskLevel.dangerous:
        return _DialogConfig(
          ...
          buttonColor: semanticColors.danger,
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                height: 56,
                decoration: BoxDecoration(
                  color: semanticColors.danger.withValues(alpha: 0.12),
                  shape: BoxShape.circle,
                ),
                child: Icon(
                  Icons.block_rounded,
              ...
              Container(
                ...
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                  color: semanticColors.danger.withValues(alpha: 0.06),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: semanticColors.danger.withValues(alpha: 0.15),
                  ),
                ),
                child: Row(
