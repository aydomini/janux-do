...
class PreferencesNotifier extends StateNotifier<AppPreferences> {
  ...
  static const String _androidNativeCdpKey = 'pref_android_native_cdp';
  ...
  static const String _cfClearanceRefreshKey = 'pref_cf_clearance_refresh';
  ...
  Future<void> setCfClearanceRefresh(bool enabled) async {
    ...
    await _prefs.setBool(_cfClearanceRefreshKey, enabled);
  }
